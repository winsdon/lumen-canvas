...
export const DEFAULT_API_BASE_URL = import.meta.env.VITE_EXTERNAL_API_BASE_URL || 'https://api.chatfire.site/v1'

// Auth API Base URL | 认证 API 基础 URL
export const AUTH_BASE_URL = import.meta.env.VITE_APP_API_BASE_URL || import.meta.env.VITE_BASE_URL || 'https://api.xmlumen.com/app-api'
