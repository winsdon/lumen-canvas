    ...
    >
      ...
      <div class="p-3">
        ...
        >
          ...
          <span
            class="text-sm text-red-600 dark:text-red-400 text-center px-2"
            >{{ data.error }}</span
          >
        </div>
        ...
        <div
          ...
          :class="isWideMedia ? 'h-[220px]' : ''"
          ref="imageContainerRef"
        >
          <n-image
            :src="data.url"
            :class="[isWideMedia ? 'w-full h-full block' : 'w-full h-auto block', { 'pointer-events-none': isInpaintMode }]"
            :object-fit="isWideMedia ? 'cover' : undefined"
          ...
          >
            <template #placeholder>
              <div
                class="w-full aspect-square flex items-center justify-center bg-gray-100 dark:bg-gray-800"
              >
                <n-spin size="small" />
              </div>
            </template>
        ...
        >
          ...
          <span class="text-sm text-[var(--text-secondary)] text-center"
            >拖放图片或点击上传</span
          >
          <input
            type="file"
